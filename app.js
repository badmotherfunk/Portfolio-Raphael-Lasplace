...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est Raphaël Lasplace')
.pauseFor(300)
...
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #10B2D0;"> React.js</span> !')
.pauseFor(1000)
.start()
...
TL1
.to(navbar, {left: '0px', ease: Power3.easeOut, duration: 0.3})
...
// Animation ScrollMagic GSA¨Presentation
